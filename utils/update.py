...
class AtualizarCliente(Cliente):
    def __init__(self, tipo, identificador, telefone, email, nome=None, razao_social=None):
        super().__init__(tipo, identificador, telefone, email, nome, razao_social)
